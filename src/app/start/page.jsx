...
export default function AuthSpacesPage() {
  ...
  const sections = [
    {
      ...
      bgImageLight: 'https://res.cloudinary.com/dmnuz4h65/image/upload/v1746778994/projet-pfe/other/loginLight_fnveqc.png',
      bgImageDark: 'https://res.cloudinary.com/dmnuz4h65/image/upload/v1746779017/projet-pfe/other/loginDark_dbyfqy.png',
    ...
    },
    {
      ...
      bgImageLight: 'https://res.cloudinary.com/dmnuz4h65/image/upload/v1746786523/projet-pfe/other/registerLight_xeablu.png',
      bgImageDark: 'https://res.cloudinary.com/dmnuz4h65/image/upload/v1746786546/projet-pfe/other/registerDark_dwhiop.png',
